...
$this->registerMetaTag(['name' => 'description', 'content' => 'Готовлю простые, вкусные и быстрые блюда по рецептам, доступным каждому. Первые блюда. Вторые блюда. Вкусные салаты. Закуски. Супы. Вегетарианские блюда. Праздничные и новогодние рецепты. Домашние рецепты. И многое другое...']);
